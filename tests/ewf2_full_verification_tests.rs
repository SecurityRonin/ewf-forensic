...
fn ewf2_ex01_external_sha1_wrong_detected() {
    ...
    let findings = EwfIntegrity::new(&data)
        ...
        .analyse();
    assert!(
        findings.iter().any(|a| matches!(a, EwfIntegrityAnomaly::ExternalSha1Mismatch { .. })),
...
fn ewf2_ex01_external_sha256_wrong_detected() {
    ...
    let findings = EwfIntegrity::new(&data)
        ...
        .analyse();
    assert!(
        findings.iter().any(|a| matches!(a, EwfIntegrityAnomaly::ExternalSha256Mismatch { .. })),
