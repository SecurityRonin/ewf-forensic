...
## [0.7.6](https://github.com/SecurityRonin/ewf-forensic/compare/ewf-forensic-v0.7.5...ewf-forensic-v0.7.6) - 2026-08-08

### Fixed

- *(tests)* an oracle that cannot OPEN the image is not a verdict on it
